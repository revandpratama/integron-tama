...
// Replace standard strings first, BEFORE adding DICT.

// Change h4 title
content = content.replace(/<Typography variant="h4" fontWeight=\{800\} sx=\{\{ color: 'text.primary' \}\}>Integration Board<\/Typography>/g, '<Typography variant="h4" fontWeight={800} sx={{ color: \'text.primary\' }}>{t.boardTitle}</Typography>');
// Wait, the h4 in original is: <Typography variant="h4" fontWeight={800} sx={{ color: '#111827' }}>Integration Board</Typography> and <Typography variant="h4" fontWeight={800} sx={{ color: 'text.primary' }}>Integration Board</Typography>
content = content.replace(/>Integration Board<\/Typography>/g, '>{t.boardTitle}</Typography>');
...
// Now structurally modify functions
